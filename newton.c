...
int main()
{
    ...
    x = newton_raphson( lambda(double, (double x), return (x*x - 9.0)), x);
    ...
    x = newton_raphson( lambda(double, (double x), return (sin(x))), x);
    ...
    x = newton_raphson( lambda(double, (double x), return (cos(x))), x);
